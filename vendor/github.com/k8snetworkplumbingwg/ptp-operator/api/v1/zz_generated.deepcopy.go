...
func (in *PtpClockThreshold) DeepCopyInto(out *PtpClockThreshold) {
	*out = *in
	if in.SysOffsetInSyncThreshold != nil {
		in, out := &in.SysOffsetInSyncThreshold, &out.SysOffsetInSyncThreshold
		*out = new(int64)
		**out = **in
	}
	if in.SysOffsetOutOfSyncThreshold != nil {
		in, out := &in.SysOffsetOutOfSyncThreshold, &out.SysOffsetOutOfSyncThreshold
		*out = new(int64)
		**out = **in
	}
	if in.SysOffsetSamples != nil {
		in, out := &in.SysOffsetSamples, &out.SysOffsetSamples
		*out = new(int64)
		**out = **in
	}
