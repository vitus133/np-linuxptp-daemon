...
type Route struct {
	...
	// Behavior specifies when compensation is applied
	// "static" - applied once at initialization (default)
	// Future: can reference HardwareConfig behavior condition names for dynamic compensation
	Behavior string `json:"behavior,omitempty" yaml:"behavior,omitempty"`

	// UserAdjustmentPs is the user/integrator adjustment in picoseconds
	// Defaults to 0. Can be overridden in HardwareConfig via PhaseAdjustment.External
	UserAdjustmentPs int `json:"userAdjustmentPs,omitempty" yaml:"userAdjustmentPs,omitempty"`
}
